...
{
    public class ShellStateCoordinator : IShellDescriptorManagerEventHandler, IShellStateManagerEventHandler
    {
        ...
        public ShellStateCoordinator(
            ...
            IEnumerable<IFeatureEventHandler> hs,
        ...
        {
            Logger.Information("Applying changes for for shell");
