    ...
    public class DefaultExtensionCompiler : IExtensionCompiler
    {
        ...
        public void Compile(CompileExtensionContext context)
        {
            ...
            try
            {
                ...
                foreach (var assemblyReference in projectFileDescriptor.References)
                {
                    ...
                    else
                    {
                        ...
                        _criticalErrorProvider.RegisterErrorMessage(string.Format(
                        ...
                        throw new CoreException(string.Format("Assembly reference '{0}' for project '{1}' cannot be loaded", assemblyReference.FullName, context.VirtualPath));
                    }
                }
            }
            catch (Exception e)
            {
                ...
                throw new CoreException(string.Format("Error compiling module \"{0}\" from file \"{1}\":\r\n{2}", moduleName, context.VirtualPath, e.Message), e);
            }
        }
