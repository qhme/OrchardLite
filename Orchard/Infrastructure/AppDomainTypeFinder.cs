...
{
    /// <summary>
    /// A class that finds types needed by Orchard by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Orchard should iterate assemblies in the app domain when loading Orchard types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Orchard assemblies arn't investigated (e.g. by not including something like "^Orchard|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the Orchard factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Orchard.
        /// </returns>
