        ...
        public void Setup(SetupContext context)
        {
            ...
            using (var bootstrapLifetimeScope = _shellContainerFactory.CreateContainer(shellSettings, shellBlueprint))
            {
                using (var environment = bootstrapLifetimeScope.CreateWorkContextScope())
                {
                    ...
                    try
                    {
                        schemaBuilder.ExecuteSql("SELECT * FROM " + "" + "Settings_ShellDescriptorRecord");
                    }
                    catch
                    {
                    ...
                    {
                        throw new CoreException("A previous Orchard installation was detected in this database with this table prefix.");
                    }
