...
namespace Orchard.Roles.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        {
            if (!Services.Authorizer.Authorize(Permissions.ManageRoles, "Not authorized to manage roles"))
        ...
        public ActionResult CreatePOST()
        {
            ...
            {
                ModelState.AddModelError("Name", "Role name can't be empty");
            }

            var role = _roleService.GetRoleByName(viewModel.Name);
            if (role != null)
            {
                ModelState.AddModelError("Name", "Role with same name already exists");
            }
        ...
        public ActionResult Edit(int id)
        {
            ...
            model.EffectivePermissions = model.RoleCategoryPermissions
                ...
                .Where(permission => _authorizationService.TryCheckAccess(permission, simulation))
        ...
        public ActionResult EditSavePOST(int id)
        {
            ...
            Services.Notifier.Information("Your Role has been saved.");
        ...
        public ActionResult Delete(int id, string returnUrl)
        {
            ...
            Services.Notifier.Information("Role was successfully deleted.");
