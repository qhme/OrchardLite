...
namespace Orchard.Roles.Services
{
    public class RoleService : IRoleService
    {
        ...
        private string GetFeatureName(string permissionName)
        {
            ...
            throw new ArgumentException(string.Format("Permission {0} was not found in any of the installed modules.", permissionName));
        }
        ...
        public IDictionary<string, IEnumerable<Permission>> GetInstalledPermissions()
        {
            ...
            foreach (var permissionProvider in _permissionProviders)
            {
                ...
                foreach (var permission in permissions)
                {
                    ...
                    string title = String.IsNullOrWhiteSpace(category) ? string.Format("{0} Feature", featureName) : category;
